...
// une par une.
nombres = [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]; 
//         ^     ^      ^       ^        ^          ^
...
// function writeArray(x) {
    for(var i =0; i< prenoms.length;i++){
            // console.log(prenoms[i].length >=4)
        }
...
// la console.
prenoms = ['Ali', 'Nour', 'Jean', 'Carole', 'Ibrahim', 'Alma'];

var prenomsString = "";

for (var i = 0; i < prenoms.length; i++){
    prenomsString = prenomsString + prenoms[i] + ", ";
}
...
var str= 'Ali Nour Jean Carole Ibrahim Alma'
